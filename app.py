# -*- coding: utf-8 -*-
"""
Created on Tue Feb 16 18:03:50 2021
...
def home():
    ...
    return render_template("main.html", education_status = education_status, marital_status = marital_status, payment_status = payment_status, alert_message = alert_message, success_message = success_message)
